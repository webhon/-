...
<p align="right">
	...
	<!-- 응답글 쓰기 버튼 추가 시작---------------------------- -->
	<input type="button" name="btn_reply" class="ahnbutton" value="답변쓰기" title="" onMouseOver="goLite(this.form.name,this.name)" onMouseOut="goDim(this.form.name,this.name)" onClick="location.href='bbs_reply.php?number=<?=$number?>&page=<?=$page?>&parentno=<?=$parentno?>'">
	<!-- 응답글 쓰기 버튼 추가 종료---------------------------- -->
</p> 
</form>
</td><tr></table>
